                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto">
                        <?php if(auth()->check() && auth()->user()->isAdmin()): ?>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('admin.tests.index')); ?>">
                                    <i class="fas fa-clipboard-list"></i> Tests
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('admin.experts.index')); ?>">
...
</html> <?php /**PATH /Users/vikalpshakya/Desktop/laravel/project/resources/views/layouts/app.blade.php ENDPATH**/ ?>